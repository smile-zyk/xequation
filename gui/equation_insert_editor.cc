...
{
    connect(context_combo_box_, &QComboBox::currentTextChanged,
            this, &ContextSelectionWidget::OnComboBoxChanged);
...
EquationInsertEditor::EquationInsertEditor(const EquationManager* manager, QWidget *parent)
...
void EquationInsertEditor::SetupUI()
{
...
void EquationInsertEditor::SetupConnections()
{
    connect(context_button_, &QPushButton::clicked, this, &EquationInsertEditor::OnContextButtonClicked);
    connect(insert_button_, &QPushButton::clicked, this, &EquationInsertEditor::OnInsertButtonClicked);
    connect(ok_button_, &QPushButton::clicked, this, &EquationInsertEditor::OnOkButtonClicked);
    connect(cancel_button_, &QPushButton::clicked, this, &EquationInsertEditor::OnCancelButtonClicked);
}

void EquationInsertEditor::OnContextButtonClicked()
{
...
void EquationInsertEditor::OnInsertButtonClicked()
{
...
void EquationInsertEditor::OnOkButtonClicked()
{
    ...
    {
        QMessageBox::warning(this, "Warning", "equation insert editor only support insert single equation!", QMessageBox::Ok);
        return;
    }
...
void EquationInsertEditor::OnCancelButtonClicked()
{
    reject();
}

void EquationInsertEditor::OnEquationAddSuccess()
{
    accept();
}
